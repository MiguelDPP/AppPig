<?php 
$nombreCorto = explode(' ', trim($data->NombreCompleto))[0];
$Foto = $data->Foto;
if($Foto == ""){
	$Foto = "images/profile/user.png";
}
?>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
									<div class="header-info">
										<span>Hola, <strong><?php echo $nombreCorto ?></strong></span>
									</div>
                                    <img src="<?php IncludeURL($Foto) ?>" width="20" alt=""/>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="<?php echo URL?>sheet/profile" class="dropdown-item ai-icon">
                                    ...
                                    <a href="<?php send('close');?>" class="dropdown-item ai-icon">
