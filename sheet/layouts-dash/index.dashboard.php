			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-3 align-items-start">
					<div class="mr-auto d-none d-lg-block">
						...
						<p class="mb-0">¡Bienvenido a AppPig!</p>
					</div>
					...
					<div class="dropdown custom-dropdown">
						<div class="btn btn-sm btn-primary light d-flex align-items-center svg-btn" data-toggle="dropdown">
							...
							<div class="text-left ml-3">
								<span class="d-block fs-16">Filtrar por periodo</span>
								<small class="d-block fs-13">4 Mayo 2022 - 4 Junio 2022</small>
							</div>
							<i class="fa fa-angle-down scale5 ml-3"></i>
						</div>
						<div class="dropdown-menu dropdown-menu-right">
							<a class="dropdown-item" href="#">4 Junio 2022 - 4 Julio 2022</a>
							<a class="dropdown-item" href="#">5 Julio 2022 - 4 Agosto 2022</a>
						</div>
					</div>
				</div>
                <div class="row">
							...
							<div class="card-body p-4">
								<div class="media ai-icon">
									...
									<div class="media-body">
										...
										<p class="mb-0">Total cerdos</p>
										<small>4% (30 dias)</small>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="row">
									<div class="col-sm-4 mb-4">
										<div class="border px-3 py-3 rounded-xl">
											...
											<p class="fs-16 mb-0">En proceso</p>
										</div>
									</div>
									<div class="col-sm-4 mb-4">
										<div class="border px-3 py-3 rounded-xl">
											<h2 class="fs-32 font-w600 counter">60</h2>
											<p class="fs-16 mb-0">Entregado</p>
										</div>
									</div>
									<div class="col-sm-4 mb-4">
										<div class="border px-3 py-3 rounded-xl">
											<h2 class="fs-32 font-w600 counter">7</h2>
											<p class="fs-16 mb-0">Cancelado</p>
										</div>
									</div>
								</div>
									...
									<div class="row align-items-center mx-0">
										...
										<div class="col-xl-9 col-lg-8 col-xxl-8 col-sm-8 px-0">
											<div class="d-flex align-items-center mb-3">
												<p class="mb-0 fs-14 mr-2 col-4 px-0">Inmunidades (24%)</p>
											...
											<div class="d-flex align-items-center  mb-3">
												<p class="mb-0 fs-14 mr-2 col-4 px-0">Latido de corazón (41%)</p>
												<div class="progress mb-0" style="height:8px; width:100%;">
											...
											<div class="d-flex align-items-center">
												<p class="mb-0 fs-14 mr-2 col-4 px-0">Peso (15%)</p>
												<div class="progress mb-0" style="height:8px; width:100%;">
					...
					<div class="col-xl-6 col-xxl-6 col-lg-12 col-md-12">
						<div class="card">
							<div class="card-header border-0 pb-0 d-sm-flex d-block">
								<div>
									<h4 class="card-title mb-1">Ingresos</h4>
									<!-- <small class="mb-0">Lorem ipsum dolor sit amet, consectetur</small> -->
								</div>
					...
					<div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12">
						<div id="user-activity" class="card">
							<div class="card-header border-0 pb-0 d-sm-flex d-block">
								<div>
									<h4 class="card-title mb-1">Mapa de clientes</h4>
