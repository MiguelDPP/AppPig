...
<?php } ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Lista de Lotes</h4>
                    <?php
                    if($admin == true){ ?>
    ...
    <script>
        var add = document.getElementById("add"), Nombre = document.getElementById("Nombre"), Descripcion = document.getElementById("Descripcion"),
            Estado = document.getElementById("Estado"), IdLote = document.getElementById("IdLote"), edit = document.getElementById("edit");
            IdLoteDelete = document.getElementById("IdLoteDelete"), deleteButton = document.getElementById("deleteButton");
